	      ...
	      <div class="checkout-right">
				...
				<table class="timetable_sub">
					...
					<tbody><tr class="rem1">
						...
						<td class="invert-image"><a href="/beer-ecommerce/public/single"><img src="<?=base_url("assets/public/images/1.png")?>" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="/beer-ecommerce/public/single"><img src="<?=base_url("assets/public/images/3.png")?>" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="/beer-ecommerce/public/single"><img src="<?=base_url("assets/public/images/2.png")?>" alt=" " class="img-responsive"></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
			...
			<div class="checkout-left">	
				...
				<form action="payment" method="post" class="creditly-card-form agileinfo_form">
				        	...
				        	<a href="/beer-ecommerce/public/payment">Make a Payment <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span></a>
			      	</div>
					</div>
